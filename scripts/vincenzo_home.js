...
const homePage = `
    ...
    <div class="d-flex justify-content-center m-3">
        <form class="form-inline">
            ...
            <button class="btn btn-outline-success col-2 ml-1" href="#!/search"><i class="fa fa-bars" aria-hidden="true"></i></button>
        </form>
    </div>
        ...
        <nav class="navbar-light bg-light fixed-bottom py-3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col text-center"><i class="fa fa-user-circle-o btn_ico" aria-hidden="true"></i><br>Your profile
                    </div>
                </div>
            </div>
        </nav>
